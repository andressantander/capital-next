<div class="relative w-full overflow-hidden" style="min-height: 100vh; background: linear-gradient(160deg, #0f0f0f 0%, #1a1a1a 40%, #0d0d0d 100%);">
    ...
    <div class="absolute top-0 right-1/4 w-[600px] h-[600px] bg-emerald-500/8 rounded-full blur-[180px] pointer-events-none"></div>
    <div class="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-emerald-400/5 rounded-full blur-[120px] pointer-events-none"></div>
    <div class="absolute top-1/2 right-0 w-[300px] h-[300px] bg-yellow-500/5 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full py-20 lg:py-0">
            ...
            <div class="text-left space-y-6 lg:space-y-8">
                ...
                <div class="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-2">
                    ...
                    <span class="text-emerald-400 text-sm font-medium">Inversión Inteligente</span>
                </div>
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                    Tu dinero<br>
                    trabajando<br>
                    <span class="bg-gradient-to-r from-emerald-400 to-emerald-500 bg-clip-text text-transparent">con estrategia</span>
                </h1>
                
                <!-- Subtitle -->
                <p class="text-lg lg:text-xl text-gray-400 font-light max-w-md leading-relaxed">
                    Metodología probada. Resultados medibles. Crece tu patrimonio sin el ruido del mercado.
                </p>
                
                <!-- CTAs - Clear and prominent -->
                <div class="flex flex-wrap gap-4 pt-2">
                    <a href="#" class="group px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-white font-semibold rounded-full transition-all duration-300 shadow-lg shadow-emerald-500/25 hover:shadow-emerald-400/40 hover:-translate-y-0.5 flex items-center gap-2">
                        Comenzar ahora
                        <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                        </svg>
                    </a>
                    <a href="#" class="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-medium rounded-full transition-all duration-300 flex items-center gap-2">
                ...
                <div class="flex flex-wrap items-center gap-6 pt-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs">+2,500 inversores</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <div>
                            <p class="text-emerald-400 font-bold text-lg">$45M+</p>
                            <p class="text-gray-500 text-xs">Gestionados</p>
                        </div>
                        <div>
                            <p class="text-emerald-400 font-bold text-lg">18.5%</p>
                            <p class="text-gray-500 text-xs">Rendimiento anual</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative h-[500px] lg:h-[650px] flex items-center justify-center">
                ...
                <div class="absolute top-8 right-8 lg:right-0 animate-float-slow z-0">
                    <div class="w-20 h-20 relative opacity-60">
                        <div class="absolute inset-0 bg-gradient-to-br from-gray-600 to-gray-800 rounded-3xl transform rotate-12"></div>
                        <div class="absolute inset-2 bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl flex items-center justify-center">
                ...
                <div class="absolute top-24 left-0 lg:-left-8 animate-float-medium z-0">
                    <div class="w-14 h-14 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl shadow-xl shadow-emerald-500/30 flex items-center justify-center transform -rotate-6">
                ...
                <div class="absolute bottom-1/4 left-4 lg:-left-4 animate-float-slow z-0">
                    <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-full shadow-xl shadow-amber-500/30 flex items-center justify-center">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-3 shadow-2xl border border-white/20">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-[10px]">Este mes</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="absolute bottom-20 right-8 lg:right-16 animate-float-medium z-30">
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-3 shadow-2xl border border-white/20">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span class="text-gray-400 text-[10px]">En vivo</span>
                        </div>
                        <p class="text-white font-bold">$145,230</p>
                        <p class="text-emerald-400 text-xs">Capital activo</p>
                    </div>
                </div>
                
                <!-- Small decorative elements -->
                <div class="absolute top-16 left-1/3 w-3 h-3 bg-emerald-400 rounded-full animate-float-fast opacity-60"></div>
                <div class="absolute bottom-1/3 right-1/4 w-2 h-2 bg-yellow-400 rounded-full animate-float-slow opacity-80"></div>
                ...
                <div class="relative z-20 transform hover:scale-[1.02] transition-transform duration-500">
                    ...
                    <div class="absolute -inset-8 bg-gradient-to-t from-emerald-500/20 via-emerald-500/5 to-transparent rounded-[4rem] blur-2xl"></div>
                        ...
                        <div class="w-full h-full bg-black rounded-[2.4rem] overflow-hidden p-0.5">
                            ...
                            <div class="w-full h-full bg-gradient-to-b from-slate-50 to-white rounded-[2.2rem] pt-10 overflow-hidden">
                                ...
                                <div class="px-4 pb-3 flex justify-between items-center">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-400 text-[9px]">Portfolio Premium</p>
                                        </div>
                                    </div>
                                ...
                                <div class="mx-3 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-4 mb-3 shadow-lg">
                                    <p class="text-gray-400 text-[10px] mb-1">Valor del portafolio</p>
                                    <div class="flex items-end justify-between">
                                        <div>
                                            <p class="text-white text-2xl font-bold">$145,230</p>
                                            <div class="flex items-center gap-1 mt-1">
                                                <div class="bg-emerald-500/20 rounded px-1.5 py-0.5">
                                                    <span class="text-emerald-400 text-[10px] font-medium">+$15,420 (12.4%)</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <p class="text-gray-500 text-[9px]">30 días</p>
                                        </div>
                                    </div>
                                ...
                                <div class="px-3 mb-3">
                                    <div class="grid grid-cols-3 gap-2">
                                        <button class="bg-emerald-500 rounded-xl py-2.5 text-white text-[10px] font-semibold shadow-sm">
                                            Invertir
                                        </button>
                                ...
                                <div class="px-3 mb-3">
                                    ...
                                    <div class="space-y-2">
                                        <div class="bg-white rounded-xl p-2.5 shadow-sm border border-gray-100 flex items-center justify-between">
                                            ...
                                            <span class="text-emerald-500 text-xs font-semibold">+18.2%</span>
                                        </div>
                                        <div class="bg-white rounded-xl p-2.5 shadow-sm border border-gray-100 flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-emerald-500 text-xs font-semibold">+8.1%</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="absolute bottom-1.5 left-1.5 right-1.5 bg-white rounded-2xl shadow-lg border border-gray-100 p-2">
                                    <div class="flex justify-around items-center">
                                        <div class="flex flex-col items-center">
                                            <div class="w-9 h-9 bg-emerald-500 rounded-xl flex items-center justify-center mb-0.5">
                                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                                </svg>
                                            </div>
                                            <span class="text-emerald-600 text-[8px] font-medium">Inicio</span>
                                        </div>
